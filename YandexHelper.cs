...
{
    public static int lat2tileY(double lat, int z)//lat=широта в градусах, z=масштаб
    {
    ...
    public static int long2tileX(double lon, int z)//lon=долгота в градусах, z=масштаб
    {
    ...
    public static string? GetCoverageMap(double lat, double lon, int mapZoomLevel, string networkType, string saveDirectory)
    {
        ...
        int y = lat2tileY(lat, mapZoomLevel);
        int x = long2tileX(lon, mapZoomLevel);
